...
@section('body')
<div class="min-h-screen bg-gradient-to-br from-base-100 to-base-200 px-4 py-12">
    <div class="max-w-6xl mx-auto">
        <!-- Main Grid Layout -->
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <!-- Registration Form Section (Left/Top) -->
            <div class="lg:col-span-1">
                <div class="sticky top-4">
                    ...
                    <div class="card bg-base-100 shadow-xl">
                        <div class="card-body">
                            <!-- Fortify Registration Form with Filament/Flux Components -->
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-control w-full mb-6">
                                    ...
                                    <input
                                        ...
                                        required
                                        autocomplete="new-password"
                                        class="input input-bordered w-full focus:outline-none focus:ring-2 focus:ring-primary @error('password_confirmation') input-error @enderror"
                                ...
                                <button
                                    type="submit"
                                    class="btn btn-primary w-full font-semibold mb-4 transition-all hover:shadow-lg"
                                >
                                    Create Account
                                </button>
            ...
            <div class="lg:col-span-2">
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-secondary mb-2">Upcoming Events</h2>
                    <p class="text-base-600">Click on any event to learn more about what's happening at SIC!</p>
                </div>

                <!-- Livewire Component -->
                <livewire:show-events-register />
            </div>
        </div>
    </div>
</div>
